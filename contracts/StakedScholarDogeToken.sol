...
contract StakedScholarDogeToken is BEP20Permit, Ownable {
    ...
    constructor() BEP20("Staked ScholarDoge token", "SSDOGE", 9) BEP20Permit() {
    ...
    /**
        @notice increases sSDOGE supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sSDOGE
