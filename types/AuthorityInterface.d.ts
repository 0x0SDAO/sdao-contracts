...
interface AuthorityInterfaceInterface extends ethers.utils.Interface {
  functions: {
...
export class AuthorityInterface extends BaseContract {
  ...
  interface: AuthorityInterfaceInterface;
