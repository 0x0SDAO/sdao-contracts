...
interface GovernorDelegatorInterface extends ethers.utils.Interface {
  functions: {
...
export class GovernorDelegator extends BaseContract {
  ...
  interface: GovernorDelegatorInterface;
