...
interface TWAPOracleUpdaterInterface extends ethers.utils.Interface {
  functions: {
...
export class TWAPOracleUpdater extends BaseContract {
  ...
  interface: TWAPOracleUpdaterInterface;
