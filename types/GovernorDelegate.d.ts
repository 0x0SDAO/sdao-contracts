...
interface GovernorDelegateInterface extends ethers.utils.Interface {
  functions: {
    ...
    "getVotesFromPercentOfstakedGovernanceTokenSupply(uint256)": FunctionFragment;
    ...
    "stakedGovernanceToken()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getVotesFromPercentOfstakedGovernanceTokenSupply",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "stakedGovernanceToken",
    values?: undefined
  ): string;
...
export class GovernorDelegate extends BaseContract {
  ...
  interface: GovernorDelegateInterface;
  ...
  functions: {
    ...
    getVotesFromPercentOfstakedGovernanceTokenSupply(
    ...
    stakedGovernanceToken(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    stakedGovernanceToken(overrides?: CallOverrides): Promise<BigNumber>;
