...
interface StakedScholarDogeTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class StakedScholarDogeToken extends BaseContract {
  ...
  interface: StakedScholarDogeTokenInterface;
