...
interface IStakedScholarDogeTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class IStakedScholarDogeToken extends BaseContract {
  ...
  interface: IStakedScholarDogeTokenInterface;
