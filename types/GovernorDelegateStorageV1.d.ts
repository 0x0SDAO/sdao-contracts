...
interface GovernorDelegateStorageV1Interface extends ethers.utils.Interface {
  functions: {
...
export class GovernorDelegateStorageV1 extends BaseContract {
  ...
  interface: GovernorDelegateStorageV1Interface;
