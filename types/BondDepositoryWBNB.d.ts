...
interface BondDepositoryWBNBInterface extends ethers.utils.Interface {
  functions: {
...
export class BondDepositoryWBNB extends BaseContract {
  ...
  interface: BondDepositoryWBNBInterface;
