...
interface OlympusBondDepositoryBNBInterface extends ethers.utils.Interface {
  functions: {
...
export class OlympusBondDepositoryBNB extends BaseContract {
  ...
  interface: OlympusBondDepositoryBNBInterface;
