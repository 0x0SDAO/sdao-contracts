...
interface ScholarDogeTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class ScholarDogeToken extends BaseContract {
  ...
  interface: ScholarDogeTokenInterface;
