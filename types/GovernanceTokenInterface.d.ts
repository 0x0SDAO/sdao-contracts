...
interface GovernanceTokenInterfaceInterface extends ethers.utils.Interface {
  functions: {
...
export class GovernanceTokenInterface extends BaseContract {
  ...
  interface: GovernanceTokenInterfaceInterface;
